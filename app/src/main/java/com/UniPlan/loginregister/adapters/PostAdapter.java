...
import com.UniPlan.loginregister.Notice_B.Post;
import com.UniPlan.loginregister.Notice_B.Post_Comment;
...
PostAdapter extends RecyclerView.Adapter<PostAdapter.PostViewHolder> {
    ...
    public void onBindViewHolder(@NonNull PostViewHolder holder, int position) {//아이템을 하나하나 보여주는 함수
        ...
        holder.post_click.setText("조회 " + Integer.toString(datas.get(position).getClick()));
